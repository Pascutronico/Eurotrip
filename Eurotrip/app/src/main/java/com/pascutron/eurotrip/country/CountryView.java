...
public class CountryView extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button button3 = (Button)rootView.findViewById(R.id.atrac);
        onClickWithParameters(AtracView.newInstance(i), button3);

        //Crear y asignar boton4

        Button button4 = (Button)rootView.findViewById(R.id.comida);
        onClickWithParameters(ComidaView.newInstance(i), button4);
